...
def sample_actual_routes(actual_routes):
    global Buffer, SAMPLE_BUFFER_SIZE, BUFFER_SIZE
    Buffer = []
...
def find_mahalanobis_thresholds():
    ...
    for cluster in Clusters:
        ...
        cluster.mahalanobis_threshold = max(0.75, np.average(cluster_distances))
...
if __name__ == "__main__":
    BFR("data/toy/standard_toy.json", "data/toy/actual_normal_toy.json", "results/recStandard_normal_toyexample.json")
